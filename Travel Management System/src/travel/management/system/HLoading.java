...
public class HLoading extends JFrame implements Runnable {
        ...
        try {
            for (int i = 0; i < 200; i++) {
                ...
                if (v < m) {
                    ...
                    i = 201;
                    setVisible(false);
                    new HotelsDashboard(username).setVisible(true);
