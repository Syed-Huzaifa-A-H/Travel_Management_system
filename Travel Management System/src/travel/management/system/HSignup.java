...
public class HSignup extends JFrame implements ActionListener {
    ...
    HSignup() {
        ...
        p1.setBackground(new Color(96,96,96));
        ...
        JLabel l2 = new JLabel("Hotelier Name");
        ...
        b1.setForeground(new Color(32,32,32));
        ...
        b2.setForeground(new Color(32,32,32));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == b1) {
            ...
            String answer = t4.getText();
                    String query = "insert into account values('"+username+"','"+name+"','"+password+"','"+security+"','"+answer+"','Hotelier')";
               try{
                   Conn c = new Conn();
                   c.s.executeUpdate(query);
                   JOptionPane.showMessageDialog(null,"Account Create Successfully.","ALERT!",JOptionPane.WARNING_MESSAGE);
                   this.setVisible(false);
                   new HotelierLogin().setVisible(true);
               }catch(Exception e){
                   e.printStackTrace();
