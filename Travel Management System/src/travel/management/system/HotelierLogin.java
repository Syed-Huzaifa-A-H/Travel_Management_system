...
public class HotelierLogin extends JFrame implements ActionListener {
...
//        setLocation(400, 200);
        ...
        JLabel t = new JLabel("HOTELIER LOGIN");
...
//        l2.setVisible(true);
        ...
        b3.setForeground(new Color(96,96,96));
        b3.setBackground(Color.white);
        b3.setBorder(new LineBorder(new Color(96,96,96)));
        ...
        if (ae.getSource() == b1) {
            try {
                ...
                if (rs.next()) {
                    ...
                    new HLoading(username).setVisible(true);
            ...
            this.setVisible(false);
            new HForgotPassword().setVisible(true);
        }
    }
